---
{"dg-publish":true,"permalink":"/all-published-notes/computer-system/software/computer/personal-changes/shell-scripts/auto-loaded/defining-bashrc-process/"}
---
...
- [[All Published Notes/Computer System/Software/Computer/Personal Changes/Shell Scripts/auto-loaded/bashrc Sub-Process/Change PS1 format\|Change PS1 format]]
- [[All Published Notes/Computer System/Software/Computer/Personal Changes/Shell Scripts/auto-loaded/bashrc Sub-Process/terminal_colors\|terminal_colors]]
- add ssh agents for git (`~/.config/bash/ssh-agent-setup.sh`)

for any runtime script, we can refer to [[All Published Notes/Computer System/Software/Computer/Personal Changes/Shell Scripts/Personal Commands\|Personal Commands]]
