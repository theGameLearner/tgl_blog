---
{"dg-publish":true,"permalink":"/all-published-notes/homelab/015-managing-local-dns-in-my-homelab/"}
---
...
As I am using this for all communication, we will use port 53 to define redirection to the homelab. The other requests will be forwarded to `1.1.1.1` and `9.9.9.9` to be managed by those DNS services.
...
To validate it, open a browser and type the custom url in a device which is connected to netbird and does not have any dns setting made.
