---
{"dg-publish":true,"permalink":"/all-published-notes/software/computer/operating-system/linux-mint/remote-connections/creating-vnc-server-in-linux-mint-tight-vnc/"}
---
...
To use x11vnc, so that we can take over existing monitor and session, you can see [[All Published Notes/Software/Computer/Operating System/LinuxMint/Remote Connections/Creating VNC server in LinuxMint - x11vnc\|Creating VNC server in LinuxMint - x11vnc]]
