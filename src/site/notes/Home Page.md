...
![Tgl logo.png|10](/img/user/Images/Logo/Tgl%20logo.png)  I am Rishabh Jain, online handle is : 'TheGameLearner'
# Rishabh Jain
...
I will be covering topics like: Unity, linux, NodeJs, homelab, etc. depending on what attracts me. This is to help others who are learning rules like me. This is also like a cheat sheet for me to quickly refer how I did something in past.

### About me
#### Personally
I am an introvert so please try to reach out to me via text based communications.
I am living in Benguluru and am looking for things I can do with my partner in the city.
...
[^1]: the publishing project is in [GitHub](https://github.com/theGameLearner/tgl_blog)
[^2]: the project content is backed up in [GitHub](https://github.com/theGameLearner/tglblog) as well
[^3]: the project is linked to [vercel](https://vercel.com/) account for publishing
[^4]: I plan on uploading the same to cloudfare pages when possible
[^5]: the deployed project can be viewed in [Vercel](https://tglblog.vercel.app/)
